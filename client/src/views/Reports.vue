...
export default {
  ...
  setup() {
    ...
    // Derived summary stats — computed so they update reactively with data
    ...
    // Hoisted max revenue so getBarHeight doesn't recompute it per bar (O(N) not O(N²))
    ...
    // Watch all four global filters and reload when any changes
    ...
    const getBarHeight = (revenue) => {
      // maxRevenue is already computed above — O(1) lookup here
